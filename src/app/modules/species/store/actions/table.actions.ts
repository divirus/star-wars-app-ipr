...
import {SpeciesTableData, TableSettings} from '../reducers/table.reducers';
...
export const setData = createAction(TableActionTypes.SetData, props<{ tableData: SpeciesTableData }>());
